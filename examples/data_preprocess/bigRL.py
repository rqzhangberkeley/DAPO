...
"""
Preprocess the bigRL dataset to parquet format
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='./data/bigRL-instruct')
    parser.add_argument('--model_type', default='instruct')
    parser.add_argument('--hdfs_dir', default=None)
    args = parser.parse_args()

    data_source = 'bigRL-instruct'
    print(f"Loading the {data_source} dataset from HuggingFace...", flush=True)
    ds = datasets.load_dataset("SynthLabsAI/Big-Math-RL-Verified")
    ...
    def make_map_fn(split):
        def process_fn(example, idx):
            ...
            llama8b_solve_rate = example.pop('llama8b_solve_rate')
