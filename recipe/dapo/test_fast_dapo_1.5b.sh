...
CKPT_PATH=${CKPT_PATH:-"/work/nvme/beok/rzhang15/checkpoints/FAST-DAPO/${exp_name}/$(date +%Y%m%d_%H%M%S)"}
mkdir -p ${CKPT_PATH}
...
PYTHONUNBUFFERED=1 python3 -m recipe.dapo.src.main_fast_dapo \
    ...
    data.val_files=[\"./data/DAPO-unique-Qwen-base/test.parquet\",\"./data/math500-Qwen-base/test.parquet\",\"./data/AIME-Qwen-base/train.parquet\",\"./data/AMC-Qwen-base/train.parquet\",\"./data/AIME2025-Qwen-base/train.parquet\"] \
...
# nohup ./recipe/dapo/test_fast_dapo_1.5b.sh > ./logs/test_fast_dapo_1.5b_all_testsets.log 2>&1 &
