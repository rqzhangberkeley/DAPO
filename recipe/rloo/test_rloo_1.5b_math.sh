...
kl_loss_coef=0.0
clip_ratio_low=0.2
clip_ratio_high=0.2 # The original RLOO.
...
loss_agg_mode="token-mean" # Use the Dr.GRPO type loss aggregation.
...
PYTHONUNBUFFERED=1 python3 -m recipe.dapo.src.main_dapo \
    ...
    data.val_files=[\"./data/AIME2024-dup4-instruct/train.parquet\",\"./data/AIME2025-dup4-instruct/train.parquet\",\"./data/Math500-instruct/test.parquet\",\"./data/AMC23-instruct/train.parquet\",\"./data/DAPO-17k-instruct/test.parquet\"] \
...
# run
# ./recipe/rloo/test_rloo_1.5b_math.sh

# Run with nohup and redirect output to log file
# nohup ./recipe/rloo/test_rloo_1.5b_math.sh > ./logs/test_rloo_1.5b_math_2.log 2>&1 &