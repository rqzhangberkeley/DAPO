#!/bin/bash
#SBATCH --job-name=1.5B-FAST-DAPO       # Job name
#SBATCH --output=./logs/DAPO-FAST-CL-1.5B_%j.out  # Output file (%j will be replaced by job ID)
#SBATCH --error=./logs/DAPO-FAST-CL-1.5B_%j.err   # Error file
