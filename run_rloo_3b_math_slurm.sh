#!/bin/bash
#SBATCH --job-name=RLOO-3B-bigRL-N24-offload-Llama-bsz4-16-3e-7       # Job name
#SBATCH --output=./logs/RLOO-3B-bigRL-N24-offload-Llama-bsz4-16-3e-7_%j.out  # Output file (%j will be replaced by job ID)
#SBATCH --error=./logs/RLOO-3B-bigRL-N24-offload-Llama-bsz4-16-3e-7_%j.err   # Error file
...
project_name='DAPO'
exp_name='3B-bigRL-RLOO-N24-offload-Llama-bsz4-16-lr3e-7'
...
#########################
train_prompt_bsz=4
gen_prompt_bsz=4 # In the base RL, we should use this as the train_prompt_bsz.
