#!/bin/bash
#SBATCH --job-name=RLOO-1.5B-DAPO-N24-KL1e-3-offload       # Job name
#SBATCH --output=./logs/RLOO-1.5B-DAPO-N24-KL1e-3-offload_%j.out  # Output file (%j will be replaced by job ID)
#SBATCH --error=./logs/RLOO-1.5B-DAPO-N24-KL1e-3-offload_%j.err   # Error file
...
project_name='DAPO'
exp_name='1.5B-Math-RLOO-dataDAPO-N24-KL1e-3-offload'
