#!/bin/bash
#SBATCH --job-name=FAST-RLOO-3B-SCD-N12+12-offload-B8-lr1e-6-middle-correct      # Job name
#SBATCH --output=./logs/FAST-RLOO-3B-SCD-N12+12-offload-B8-lr1e-6-middle-correct_%j.out  # Output file (%j will be replaced by job ID)
#SBATCH --error=./logs/FAST-RLOO-3B-SCD-N12+12-offload-B8-lr1e-6-middle-correct_%j.err   # Error file
...
project_name='DAPO'
exp_name='3B-SCD-FAST-RLOO-N12+12-offload-B8-lr1e-6-middle-correct'
