#!/bin/bash
#SBATCH --job-name=RLOO-DAPO-3B-SCD-N24-offload-B32-hard       # Job name
#SBATCH --output=./logs/RLOO-DAPO-3B-SCD-N24-offload-B32-hard_%j.out  # Output file (%j will be replaced by job ID)
#SBATCH --error=./logs/RLOO-DAPO-3B-SCD-N24-offload-B32-hard_%j.err   # Error file
...
project_name='DAPO'
exp_name='3B-SCD-RLOO-DAPO-N24-offload-B32-hard'
